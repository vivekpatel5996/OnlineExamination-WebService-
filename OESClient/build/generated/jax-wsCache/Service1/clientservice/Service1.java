 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://noesservices.cloudapp.net/Service1.svc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://noesservices.cloudapp.net/Service1.svc?wsdl");
